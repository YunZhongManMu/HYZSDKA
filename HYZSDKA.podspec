#
#  Be sure to run `pod spec lint HYZSDKA.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name         = "HYZSDKA"
  s.version      = "0.0.2"
  s.summary      = "上传.framework静态库到cocoapods"

  # s.description  = <<-DESC
                   # DESC

  s.homepage     = "https://github.com/YunZhongManMu/HYZSDKA.git"
  s.license      = "MIT"
